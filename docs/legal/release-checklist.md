...
- `npm run check`：JavaScript 语法与契约检查通过；加载 ESP-IDF 5.5.2 后严格门禁为 `205 passed / 0 pending / 0 failed`。最近一次 STD / Pro / Max 构建证据见 [`docs/ops/verification-matrix.md`](../ops/verification-matrix.md)。
