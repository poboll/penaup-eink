...
- 继续收口 Web、设备工具与微信小程序的浅灰白草纸面：白色纸片按钮、细黑边、轻微压印阴影和鼠尾草绿激活态现在使用同一套几何与触控尺寸；小程序导航栏也同步到 `#F0F0EC`，避免首屏闪回旧米黄色。
...
- 类纸表面再收口为更浅的灰白草纸：加入低对比斜向纤维、轻噪点和纸片式不对称圆角按钮；模板中心逐张显示 Pro 3.68 英寸竖向输出规格，主页同步展示约 258.7 PPI 与兼容 film 协议方向。
